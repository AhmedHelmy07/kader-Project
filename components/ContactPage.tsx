      ...
      <div className="max-w-3xl mx-auto bg-gradient-to-br from-black/40 to-black/20 rounded p-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-400">Send us a message and we'll respond to your email.</div>
          </div>
        </div>
        <div className="bg-black/20 p-4 rounded">
          <input placeholder="Your email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full p-3 mb-3 bg-transparent border rounded" />
          <textarea placeholder="Message" value={text} onChange={(e) => setText(e.target.value)} className="w-full p-3 mb-3 bg-transparent border rounded" rows={6} />
